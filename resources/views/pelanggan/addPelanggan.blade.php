...
<head>
    ...
    <title>BGES TELKOM - TAMBAH PELANGGAN</title>
    ...
    <div class="container">
        <div class="row" style="margin-top: 50px">
            ...
            <div class="title_sec col-lg-4 col-md-4 col-sm-12">
                <div id="cnt_form">
                    {!! Form::open(['url'=>route('pelanggan.store'), 'class'=>'contact']) !!}
                    ...
                    <div class="form-group">
                        <input type="text" name="cp" maxlength="50" class="form-control name-field"
                               placeholder="Nama Contact Person" value="{{old('cp')}}">
                    ...
                    <div class="form-group">
                        <input type="text" name="nope" maxlength="13" class="form-control name-field"
                               required="required"
                               placeholder="Nomor HP ex : 081xxx" value="{{old('nope')}}">
                        {!! $errors->first('nope', '<p class="help-block">Harus Berupa Angka! Maksimal 13 Digit<br>
                        Minimal 9 Digit</br></p>') !!}
                    </div>

                    <div class="form-group">
                        <input type="text" maxlength="12" name="tlp" class="form-control name-field"
                               placeholder="Nomor Telepon ex : 0331396xxx" value="{{old('tlp')}}">
                        {!! $errors->first('tlp', '<p class="help-block">Maksimal 12 Digit, Harus Berupa Angka</p>') !!}
                    </div>

                    <div class="form-group">
                        {!! $errors->first('alamat', '<p class="help-block">Maksimal 100 Karakter</p>') !!}
                        <textarea maxlength="100" class="form-control" id="message" name="alamat" required="required"
