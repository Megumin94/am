...
<head>
    ...
    <title>BGES TELKOM - TAMBAH LAYANAN</title>
...
<section id="abt_sec">
    <div class="container">
        <div class="row" style="margin-top: 50px">
            ...
            {!! Form::open(['url'=>'/admin/layanan', 'class'=>'contact']) !!}
                ...
                <div id="cnt_form">
                    <div class="form-group">
                        ...
                        <input type="text" name="layanan" maxlength="50" class="form-control name-field"
                               required="required"
                               placeholder="Nama Produk" value="{{old('layanan')}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="instalasi" maxlength="50" class="form-control name-field"
                               required="required"
                               placeholder="Daerah Instalasi" value="{{old('instalasi')}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="harga" maxlength="10" class="form-control name-field"
                               required="required"
                               placeholder="Harga Layanan" value="{{old('harga')}}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="pt" type="text" name="term" class="form-control name-field"
                                required="required" value="{{old('term')}}" onclick="changetextbox()">
                            <option value="">Payterm</option>
            ...
            <div class="title_sec col-lg-5 col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <input id="ab" type="text" name="abonemen" maxlength="10" class="form-control name-field"
                           placeholder="Abonemen" value="{{old('abonemen')}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input id="tgl" type="text" name="kontrak" maxlength="10" class="form-control name-field"
                           required="required"
                           placeholder="Akhir Kontrak" value="{{old('kontrak')}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="biaya" maxlength="10" class="form-control name-field"
                           required="required"
                           placeholder="Biaya PSB/OTC" value="{{old('biaya')}}">
                </div>
