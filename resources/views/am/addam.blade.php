...
<head>
    ...
    <title>BGES TELKOM - TAMBAH AM</title>
        ...
        <div class="container">
            <div class="row" style="margin-top: 50px">
                ...
                <div class="title_sec col-lg-4 col-md-4 col-sm-12">
                    <div id="cnt_form">
                        {!! Form::open(['url'=>route('am.store'), 'class'=>'contact']) !!}
